...
const CITIES = [
	...
	},
	{
		...
		safePoints: [
			{ x: 320, y: 145 }, { x: 320, y: 155 }, { x: 320, y: 165 }, { x: 320, y: 175 }, { x: 320, y: 185 },
			{ x: 330, y: 140 }, { x: 330, y: 150 }, { x: 330, y: 160 }, { x: 330, y: 170 }, { x: 330, y: 180 }, { x: 330, y: 190 }, { x: 330, y: 200 },
			{ x: 340, y: 135 }, { x: 340, y: 145 }, { x: 340, y: 155 }, { x: 340, y: 165 }, { x: 340, y: 175 }, { x: 340, y: 185 }, { x: 340, y: 195 }, { x: 340, y: 205 },
			{ x: 350, y: 130 }, { x: 350, y: 140 }, { x: 350, y: 150 }, { x: 350, y: 160 }, { x: 350, y: 170 }, { x: 350, y: 180 }, { x: 350, y: 190 }, { x: 350, y: 200 }, { x: 350, y: 210 }, { x: 350, y: 220 },
			{ x: 360, y: 135 }, { x: 360, y: 145 }, { x: 360, y: 155 }, { x: 360, y: 165 }, { x: 360, y: 175 }, { x: 360, y: 185 }, { x: 360, y: 195 }, { x: 360, y: 205 }, { x: 360, y: 215 },
			{ x: 370, y: 140 }, { x: 370, y: 150 }, { x: 370, y: 160 }, { x: 370, y: 170 }, { x: 370, y: 180 }, { x: 370, y: 190 }, { x: 370, y: 200 }, { x: 370, y: 210 },
			{ x: 380, y: 145 }, { x: 380, y: 155 }, { x: 380, y: 165 }, { x: 380, y: 175 }, { x: 380, y: 185 }, { x: 380, y: 195 }
		]
	},
	{
		id: 'izmir',
		...
		safePoints: [
			{ x: 80, y: 220 }, { x: 80, y: 230 }, { x: 80, y: 240 }, { x: 80, y: 250 }, { x: 80, y: 260 },
			{ x: 90, y: 215 }, { x: 90, y: 225 }, { x: 90, y: 235 }, { x: 90, y: 245 }, { x: 90, y: 255 }, { x: 90, y: 265 },
			{ x: 100, y: 215 }, { x: 100, y: 225 }, { x: 100, y: 235 }, { x: 100, y: 245 }, { x: 100, y: 255 }, { x: 100, y: 265 },
			{ x: 110, y: 220 }, { x: 110, y: 230 }, { x: 110, y: 240 }, { x: 110, y: 250 }, { x: 110, y: 260 },
			{ x: 40, y: 245 }, { x: 40, y: 250 }, { x: 40, y: 255 },
			{ x: 45, y: 245 }, { x: 45, y: 250 }, { x: 45, y: 255 },
			{ x: 65, y: 260 }, { x: 65, y: 265 }, { x: 65, y: 270 },
			{ x: 75, y: 260 }, { x: 75, y: 265 }, { x: 75, y: 270 }, { x: 75, y: 275 }
		]
	},
	{
		id: 'eskisehir',
		...
		safePoints: [
			{ x: 250, y: 160 }, { x: 250, y: 170 }, { x: 250, y: 180 }, { x: 250, y: 190 },
			{ x: 260, y: 155 }, { x: 260, y: 165 }, { x: 260, y: 175 }, { x: 260, y: 185 }, { x: 260, y: 195 },
			{ x: 270, y: 150 }, { x: 270, y: 160 }, { x: 270, y: 170 }, { x: 270, y: 180 }, { x: 270, y: 190 }, { x: 270, y: 200 },
			{ x: 280, y: 155 }, { x: 280, y: 165 }, { x: 280, y: 175 }, { x: 280, y: 185 }, { x: 280, y: 195 }, { x: 280, y: 205 },
			{ x: 290, y: 160 }, { x: 290, y: 170 }, { x: 290, y: 180 }, { x: 290, y: 190 }, { x: 290, y: 200 },
			{ x: 300, y: 165 }, { x: 300, y: 175 }, { x: 300, y: 185 }, { x: 300, y: 195 }
		]
	}
];
...
function initMap() {
	...
	if (mapSection.innerHTML === '') {
		...
		CITIES.forEach(city => {
			...
			if (btnExplore) {
				btnExplore.innerText = `${city.name}'u İncele`;
				if (city.id === 'ankara' || city.id === 'izmir' || city.id === 'eskisehir') {
					btnExplore.innerText = `${city.name}'i İncele`;
				}
				...
				if (profile.preferred_locations && Array.isArray(profile.preferred_locations)) {
					profile.preferred_locations.forEach(loc => {
						...
						if (parts.length >= 2) {
							...
							if (city === 'istanbul' || city === 'i̇stanbul') {
							...
							} else if (city === 'izmir' || city === 'i̇zmir') {
							...
							} else if (city === 'eskisehir' || city === 'eskişehir') {
...
function renderMapUsers(cityId, users) {
	...
	const displayLimit = Math.min(stableUsers.length, cityObj.safePoints.length);
	const viewBox = cityObj.viewBoxObj;

	for (let i = 0; i < displayLimit; i++) {
		const user = stableUsers[i];
		const coords = cityObj.safePoints[i];

		// Convert SVG coordinates to percentages of viewBox
		const leftPercent = ((coords.x - viewBox.x) / viewBox.w) * 100;
		const topPercent = ((coords.y - viewBox.y) / viewBox.h) * 100;
